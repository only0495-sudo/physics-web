(function () {
  ...
  const activities = [
    ...
    },
    {
      ...
      category: "力學",
      format: "儀表",
      summary: "用電梯與加速情境分清楚重量、正向力與體感重量。",
      goal: ["以牛頓第二定律求正向力", "說明視重與實際重力的差異"],
      task: "先預測電梯開始上升、等速、減速時體重計讀值的大小關係。",
      question: "電梯向上移動時，體重計讀值一定大於 mg 嗎？",
      demo: ["固定人的質量", "依序比較三種加速度", "用受力圖核對儀表讀值"],
  ...
  const measurements = {
    ...
    "正向力與視重.html": { settingLabel: "情境、質量與外力／加速度", settingPlaceholder: "例：電梯向上加速，m=60 kg", resultLabel: "正向力 N 與視重", resultPlaceholder: "例：N=… N，大於 mg", prompt: "區分速度方向與加速度方向，記錄體重計讀值而不是只寫上升或下降。" },
